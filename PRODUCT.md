...
- Grandfathering is half-advertised, deliberately (#221). That a **backer tier includes a lifetime Membership** is advertised freely, since the campaign sells it as a reward. That an **existing account, by itself, becomes permanently free at enforcement** is never advertised: no PRISM surface, in the campaign window or after, invites anyone to create an account in order to get in ahead of the flip. The control on cohort size is the closed signup window, not publicity.
